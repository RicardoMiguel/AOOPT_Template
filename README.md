#Template Method exercise - Tic Tac Toe game

Change the Tic Tac Toe game to implement the Template Method pattern.

To do this:
* Make the Game class abstract with the method 'calculateNextMove' as its abstract member;
